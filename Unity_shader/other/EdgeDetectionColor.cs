...
namespace UnityStandardAssets.ImageEffects
{
	...
	public class EdgeDetectionColor : PostEffectsBase
	{
		...
		void SetCameraFlag ()
		{
			...
			if (mode == EdgeDetectMode.TriangleDepthNormals || mode == EdgeDetectMode.RobertsCrossDepthNormals || mode == EdgeDetectMode.TriangleLuminance)
		...
		void OnRenderImage (RenderTexture source, RenderTexture destination)
		{
            ...
            edgeDetectMaterial.SetFloat("_NoiseFactor", noiseFactor);
